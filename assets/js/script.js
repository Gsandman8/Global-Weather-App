...
searchForm.addEventListener('submit', function(e){
    ...
    const CityArray = localStorage.getItem('city') ? JSON.parse(localStorage.getItem('city')) : [];
        ...
        .then(function(data){
            ...
            for(let i = 2; i < data.list.length; i++){
                ...
                if (!uiqueDates[date]){
                    ...
                    forecastItem.style.backgroundColor = 'pink';
    ...
    for (let i = 0; i < CityArray.length; i++) {
        ...
        searchHistoryItem.textContent = CityArray[i];
